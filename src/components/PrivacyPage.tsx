  ...
  return <article className="privacy-page stack" aria-labelledby="privacy-heading">
    ...
    <section aria-labelledby="privacy-data"><h2 id="privacy-data">Qué datos se tratan y para qué</h2>
      <ul>
        ...
        <li>Listas de deseos: nombres de tus listas privadas, cartas deseadas, idiomas y datos del catálogo guardados con cada carta, para organizar las cartas que quieres conseguir, separadas de tu colección.</li>
    ...
    <section aria-labelledby="privacy-storage"><h2 id="privacy-storage">Almacenamiento técnico en el navegador</h2>
      ...
      <p>La aplicación instalable utiliza un service worker y una caché técnica limitada a la pantalla pública sin conexión y sus iconos. Esa caché no guarda tu colección, listas de deseos, mensajes, respuestas de autenticación ni precios. La sesión y preferencias conservan el almacenamiento habitual descrito arriba. No se ponen operaciones en cola para enviarlas después ni se activan notificaciones push al instalar.</p>
      <p>Sin conexión no se muestran los datos privados ni se permiten cambios. Los borradores abiertos pueden conservarse únicamente en memoria mientras la pestaña siga abierta. Borrar los datos del sitio elimina también la caché técnica; desinstalar el acceso directo puede no borrar todos los datos del navegador.</p>
    </section>
    <section aria-labelledby="privacy-retention"><h2 id="privacy-retention">Durante cuánto tiempo</h2>
      <p>La cuenta, la colección y las listas de deseos se conservan hasta que solicites su eliminación. El borrado de cuenta elimina de la base activa la cuenta, sus colecciones, sus listas de deseos y las cartas de esas listas, y los mensajes asociados a su identificador. Los mensajes enviados sin sesión no se vinculan automáticamente a una cuenta por compartir correo.</p>
    ...
    <section aria-labelledby="privacy-rights"><h2 id="privacy-rights">Tus opciones y derechos</h2>
      <p>Desde la gestión de cuenta puedes exportar una copia JSON de tu colección, cambiar la contraseña o solicitar el borrado de cuenta. Puedes rectificar los datos de tu colección y gestionar tus listas de deseos en la aplicación. La copia JSON incluye únicamente la colección, no las listas de deseos ni sus cartas, los mensajes de contacto ni todos los datos tratados por los proveedores.</p>
